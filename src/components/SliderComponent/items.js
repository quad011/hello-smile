export default {
  ...
  1: {
    ...
    caption: "Pasta za zube",
    description:
      "Spoj slatkog ukusa jabuke i kremaste teksture čini ovu pastu neodoljivom za tvoje čulo ukusa. Pripremi se za slatko zadovoljstvo koje će te oboriti s nogu već nakon prve upotrebe!",
